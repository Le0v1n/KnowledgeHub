...
- [docker官网](https://docs.docker.com/desktop/setup/install/windows-install/)

### 1.7.3. 安装和配置Dify

- [dify官网](https://dify.ai/)
- [github仓库](https://github.com/langgenius/dify)
- [中文README文档](https://github.com/langgenius/dify/blob/main/docs/zh-CN/README.md)

从Dify的官方GitHub仓库克隆代码：
...
# 拷贝env文件（官方提供的是.env.example，这个只是一个示例，但docker-compose是需要.env文件的，所以我们拷贝一个）
...
<div align=center>
    <img src=./imgs_markdown/2025-11-19-09-17-06.png
    width=100%></br><center></center>
</div>
