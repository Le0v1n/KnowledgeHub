...
> 这个仓库存放了日常的学习笔记，欢迎大家来访！如果你有疑问请 [联系我](#联系我) 😊 如果对你有帮助，请 ⭐ 一下
...
| 领域 | 内容 |
|------|------|
| 🤖 大模型 | LangChain、RAG、Prompt工程、Transformer、Word2Vec |
...
更多内容请见：
- 📖 [CSDN 博客-Le0v1n](https://blog.csdn.net/weixin_44878336)
- 🎬 [Bilibili 视频-L0o0v1N](https://space.bilibili.com/13187602)
...
| 目录 | 说明 |
|------|------|
| [SemanticSegmentation/Fast-SCNN](./SemanticSegmentation/Fast-SCNN) | 语义分割 |
| [Classification/ViT](./Classification/ViT) | 图像分类 - ViT |
| [FaceRecognition](./FaceRecognition) | 人脸识别 |
| [HumanPoseEstimation](./HumanPoseEstimation) | 人体姿态估计 |
| [CLIP/clip](./CLIP/clip) | CLIP 模型 |

### 🧠 深度学习

| 目录 | 说明 |
|------|------|
| [PyTorch](./PyTorch) | PyTorch 相关学习笔记 |
...
| [多线程与多进程](./Python/多线程与多进程) | 多线程与多进程 |
| [正则表达式](./Python/正则表达式) | 正则表达式 |
...
| 目录 | 说明 |
|------|------|
| [ONNX/code](./ONNX/code) | ONNX 相关代码 |

### 💻 工具

| 目录 | 说明 |
|------|------|
| [Windows](./Windows) | Windows 使用技巧 |
| [Writing/Office](./Writing/Office) | Office 技巧 |
| [Configs/Typora Themes](./Configs/Typora%20Themes) | Typora 主题 |
| [utils](./utils) | 工具函数 |
| [scirpts](./scirpts) | 脚本工具 |
